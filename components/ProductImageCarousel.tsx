  ...
  return (
    ...
    >
      <div ref={emblaRef} className="overflow-hidden">
        <div
          className="flex -mx-4 touch-pan-y"
          style={{
        ...
        <div className="flex items-center justify-center w-full gap-2">
          ...
          {images.map((image, i) => (
            <Button
              ...
              size="icon"
              className={cn(
                "group relative aspect-square w-full h-full max-w-[70px] md:max-w-[100px] rounded-none shadow-sm hover:bg-transparent focus-visible:ring-foreground",
